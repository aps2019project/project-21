...
public class HeroMaker {
    public static void main() throws Exception {
        ...
        specialPower = new Spell("Ezhdehaye Haftsar's Spell", 0, 0,
                targetType, effect, ApplyType.ON_ATTACKER, "Disarms a selected attacker.");
        ...
        specialPower = new Spell("Rakhsh's Spell", 0, 1,
                targetType, effect, ApplyType.ON_ATTACKER, "Stuns one opponent attacker for one turn.");
        ...
        specialPower = new Spell("Zahak's Spell", 0, 0,
                targetType, effect, ApplyType.ON_ATTACKER, "Poisons an opponent on attack for 3 turns.");
        ...
        specialPower = new Spell("Kaveh's Spell", 0, 1,
                targetType, effect, ApplyType.ON_CELL, "Gives a selected cell holy buff for 3 turns.");
        ...
        specialPower = new Spell("Arash's Spell", 0, 2,
                targetType, effect, ApplyType.ON_ATTACKER, "Gives 4 damages to all opponent attackers in the same row as selected hero.");
        ...
        specialPower = new Spell("Afsaneh's Spell", 0, 1,
                targetType, effect, ApplyType.ON_ATTACKER, "Dispels an opponent attacker.");
        ...
        specialPower = new Spell("Esfandiar's Spell", 0, 0,
                targetType, effect, ApplyType.ON_ATTACKER, "Has 3 holy buffs continuously.");
