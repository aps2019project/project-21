...
public class HeroMaker {
    public static void main(String[] args) throws IOException {
        ...
        specialPower = new Spell("Simorgh's Spell", 0, 5,
                targetType, effect, "Stuns all opp attackers for one turn.");
        ...
        specialPower = new Spell("Ezhdehaye Haftsar's Spell", 0, 0,
                targetType, effect, "Disarms one selected attacker.");
        ...
        specialPower = new Spell("Rakhsh's Spell", 0, 1,
                targetType, effect, "Stuns one opponent attacker for one turn.");
        ...
        specialPower = new Spell("Zahak's Spell", 0, 0,
                targetType, effect, "Poisons an opponent on attack for 3 turns.");
        ...
        specialPower = new Spell("Kaveh's Spell", 0, 1,
                targetType, effect, "Gives a selected cell holy buff for 3 turns.");
        ...
        specialPower = new Spell("Arash's Spell", 0, 2,
                targetType, effect, "Gives 4 damages to all opponent attackers in the same row as selected hero.");
        ...
        specialPower = new Spell("Afsaneh's Spell", 0, 1,
                targetType, effect, "Dispels an opponent attacker.");
        ...
        specialPower = new Spell("Esfandiar's Spell", 0, 0,
                targetType, effect, "Has 3 holy buffs continuously.");
