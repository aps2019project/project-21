...
public class HostShopView {
    private static HostShopView instance = new HostShopView();

    public static HostShopView getInstance() {
        return instance;
    }

    private HostShopView() {
    }
    ...
    public static void setInstance(HostShopView instance) {
        HostShopView.instance = instance;
    }
